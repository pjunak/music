...
pub const MODEL_ROLES: &[ModelRoleDefinition] = &[
    ModelRoleDefinition {
        ...
        runtime_contract: "assistant-music-tagger-input/v21+output/v3+local-context/v2",
    },
    ModelRoleDefinition {
        id: "playlist_planner",
        ...
        required_capability_ids: &[STRUCTURED_TEXT_CAPABILITY],
        configuration_available: true,
        runtime_contract: "assistant-playlist-planner-input/v4+output/v1+closed-ids/v1",
    },
    ModelRoleDefinition {
        id: "tag_cleanup",
