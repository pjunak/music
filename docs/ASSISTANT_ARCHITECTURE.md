...
| Mood tagging (`music_tagger`) | `assistant-music-tagger-input/v16+output/v3+local-context/v1` | `assistant-model-music-tagging-disclosure/v10` | `model-context-tagger/v6` | `music-tagging-quality-v1` | `assistant.model-music-tagging` |
