...
// module fails to parse and #root is left empty), the watchdog loads the legacy
// TV fallback instead of leaving a blank screen. It keys on *bundle execution*,
// not React paint, so — unlike the old 500 ms paint timer this replaces — it
// can't false-fire on a capable-but-slow browser. Set unconditionally (before
// the ?tv branch too) so the signal is purely "the bundle ran".
